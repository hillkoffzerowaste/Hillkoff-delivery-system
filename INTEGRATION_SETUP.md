...
ถูกถอดออกทั้งหมดเมื่อ 2026-08-16 เพราะเลิกใช้แล้ว แอปที่เคยพ่วงไว้คือ `scan-to-sheet` ถูกเพิกถอนกุญแจ
และ collection `api_clients` ถูกลบออกจาก Firestore เมื่อ 2026-08-17 (มีไฟล์ export อยู่ใน `backups/` ซึ่งไม่ได้ commit)
