...
export function dispatchDashboardReadPlan(selectedDate) {
  ...
  // serviceDate ถูกจำกัดด้วยตัวมันเองอยู่แล้ว (อ่านเท่าที่มีในวันนั้น) จึงตั้งเพดานกันพลาดไว้สูงได้
  // แต่คิวที่ยังไม่ปิดสะสมข้ามวันได้เรื่อยๆ ต้องคุมเพดานไม่ให้กวาดทั้ง backlog ทุกครั้งที่ refresh
  return [
    { collection: "orders", field: "serviceDate", op: "==", value: selectedDate, limit: 500 },
